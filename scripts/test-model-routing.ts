...
const gptOssCatalogModel = ANTIGRAVITY_MODELS.find((m) => m.id === "gpt-oss-120b")!;
...
const reqGptOss = buildRequest(gptOssCatalogModel, dummyContext, "test-proj", {}, "gpt-oss-120b-medium");
